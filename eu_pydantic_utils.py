...
from utils.eu_utils.eu_prompts import extractor_system_prompt
...
a,b = execute_lang_chain(extractor_system_prompt, parser.get_format_instructions(), input_con, model=llm)
print(b)